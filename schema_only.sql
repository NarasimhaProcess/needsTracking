...
CREATE POLICY "FileUploadView nnqi8z_0" ON storage.objects FOR SELECT USING ((bucket_id = 'needstracking'::text));
...
CREATE POLICY "FileUploadView nnqi8z_1" ON storage.objects FOR INSERT WITH CHECK ((bucket_id = 'needstracking'::text));
...
CREATE POLICY "FileUploadView nnqi8z_2" ON storage.objects FOR UPDATE USING ((bucket_id = 'needstracking'::text));
...
CREATE POLICY "FileUploadView nnqi8z_3" ON storage.objects FOR DELETE USING ((bucket_id = 'needstracking'::text));
